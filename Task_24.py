...
blueberries = [random.randint(1, 20) for i in range(n)]
print(f'{blueberries} - ягод на кустах')

sum = list()
for i in range(len(blueberries) - 1):
    sum.append(blueberries[i - 1] + blueberries[i] + blueberries[i + 1])
sum.append(blueberries[-2] + blueberries[-1] + blueberries[0])
